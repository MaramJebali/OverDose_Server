...
if settings.DEBUG:
    ...
    # Servir les crops de segmentation stockés dans uploads/
    _uploads_dir = Path(settings.BASE_DIR) / "uploads"
    urlpatterns += static("/uploads/", document_root=str(_uploads_dir))
